        ...
        <div className={styles.container}>
            <div className={styles.headerSection}>
                <div>
                    <Text className={styles.header}>
                        Log Throughput Activity Output
                    </Text>
                    <Text className={styles.subtitle}>
                        Record technician time entries with automatic duration calculation
                    </Text>
                </div>
                <div className={styles.statsRow}>
                    ...
                    <Card className={styles.statCard}>
                        <Text className={styles.statLabel}>Total Hours</Text>
                        <Text className={styles.statValue}>{getTotalHours()}</Text>
                    </Card>
                </div>
            </div>
            ...
            <div className={styles.scrollArea}>
                {rows.map((row, index) => {
                    ...
                    const hasAnyData = row.technicianId || row.workCenterId || row.activityId;
                            ...
                            <div className={styles.formGrid}>
                                ...
                                <div className={styles.formField}>
                                    ...
                                    <DatePicker
                                        ...
                                        onSelectDate={(date) => handleRowChange(row.id, "startDate", date || null)}
